<?php $cname = 'price'; ?>
<div class="article" id="e<?php echo $cname ?>"><?php echo $z1[0]['price'] ?></div>
...
<div class="edit article hidden" id="<?php echo $cname ?>">
    <form class="form-group" id="postForm" action="<?php $_SERVER['DOCUMENT_ROOT']?>/agenda/processes/uprice.php?id=<?php echo $z1[0]['id'] ?>" method="POST" enctype="multipart/form-data">
        <input class="form-control hidden" name="redirect" value="<?php echo $currentPage ?>">
        <textarea class="click2edit form-control" name="price"><?php echo $z1[0]['price'] ?></textarea>
